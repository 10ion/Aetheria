...
public class custom_model extends ModelBase {
	...
	public custom_model() {
		...
		ears.cubeList.add(new ModelBox(ears, 4, 4, -3.5F, -7.0F, -2.5F, 1, 1, 1, 0.0F, false));
		ears.cubeList.add(new ModelBox(ears, 0, 4, 2.5F, -7.0F, -2.5F, 1, 1, 1, 0.0F, false));
		ears.cubeList.add(new ModelBox(ears, 5, 1, 2.5F, -8.0F, -3.0F, 1, 1, 1, 0.0F, false));
