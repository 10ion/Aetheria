...
import net.aetheria.mod.procedures.Lupin1Procedure;
...
public class LupinEntity extends AetheriaModElements.ModElement {
	...
	public class lupin extends EntityModel<Entity> {
		...
		public lupin() {
			...
			addBoxHelper(Head, 14, 16, -2.0F, -3.0F, -8.0F, 4, 3, 4, 0.0F, false);
			addBoxHelper(Head, 0, 0, -3.0F, -10.0F, -3.0F, 2, 2, 1, 0.0F, false);
			addBoxHelper(Head, 0, 0, 1.0F, -10.0F, -3.0F, 2, 2, 1, 0.0F, false);
			Body = new ModelRenderer(this);
			Body.setRotationPoint(0.0F, 11.0F, 2.0F);
			setRotationAngle(Body, -1.1345F, 0.0F, 0.0F);
			addBoxHelper(Body, 0, 16, -1.0F, -0.2372F, 0.0701F, 2, 2, 10, 0.0F, false);
			...
			addBoxHelper(RightLeg, 0, 5, -2.1F, 11.0F, -3.0F, 1, 1, 1, 0.0F, false);
			addBoxHelper(RightLeg, 3, 4, -0.1F, 11.0F, -3.0F, 1, 1, 1, 0.0F, false);
			LeftLeg = new ModelRenderer(this);
			LeftLeg.setRotationPoint(1.9F, 12.0F, 0.0F);
			addBoxHelper(LeftLeg, 0, 3, 1.0F, 11.0F, -3.0F, 1, 1, 1, 0.0F, false);
			addBoxHelper(LeftLeg, 0, 3, -1.0F, 11.0F, -3.0F, 1, 1, 1, 0.0F, false);
		}
