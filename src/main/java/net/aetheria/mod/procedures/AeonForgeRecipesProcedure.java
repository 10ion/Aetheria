...
import net.aetheria.mod.item.UmberStalkItem;
import net.aetheria.mod.item.PizzaItem;
import net.aetheria.mod.item.OinkItem;
import net.aetheria.mod.item.MoralmedlyItem;
import net.aetheria.mod.item.CheeseItem;
import net.aetheria.mod.block.RainbowCapBlock;
import net.aetheria.mod.block.GhostmorelBlock;
import net.aetheria.mod.block.FireshroomBlock;
import net.aetheria.mod.block.AstralToadstoolBlock;
