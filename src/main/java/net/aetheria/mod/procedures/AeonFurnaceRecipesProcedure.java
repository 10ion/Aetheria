...
import net.aetheria.mod.item.ZincIngotItem;
import net.aetheria.mod.item.TinIngotItem;
import net.aetheria.mod.item.SterlingSilverIngotItem;
import net.aetheria.mod.item.SteelIngotItem;
import net.aetheria.mod.item.SilverIngotItem;
import net.aetheria.mod.item.RoseGoldIngotItem;
import net.aetheria.mod.item.RedBrassIngotItem;
import net.aetheria.mod.item.PewterIngotItem;
import net.aetheria.mod.item.NIckelIngotItem;
import net.aetheria.mod.item.MagnegoldIngotItem;
import net.aetheria.mod.item.LeadIngotItem;
import net.aetheria.mod.item.FlowingWaterSteelIngotItem;
import net.aetheria.mod.item.ElectrumIngotItem;
import net.aetheria.mod.item.DarkIronIngotItem;
import net.aetheria.mod.item.CopperIngotItem;
import net.aetheria.mod.item.CobaltIngotItem;
import net.aetheria.mod.item.BronzeIngotItem;
import net.aetheria.mod.item.BrassIngotItem;
import net.aetheria.mod.item.BlacksteelIngotItem;
import net.aetheria.mod.item.BlackBronzeIngotItem;
import net.aetheria.mod.item.BismuthIngotItem;
import net.aetheria.mod.item.BismuthBronzeIngotItem;
...
public class AeonFurnaceRecipesProcedure extends AetheriaModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure AeonFurnaceRecipes!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure AeonFurnaceRecipes!");
			return;
		}
									...
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										|| (((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(Items.GOLD_INGOT, (int) (1)).getItem()) && (((new Object() {
													public int getAmount(BlockPos pos, int sltid) {
														AtomicInteger _retval = new AtomicInteger(0);
														TileEntity _ent = world.getTileEntity(pos);
														if (_ent != null) {
		...
		if ((((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(PewterIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(BronzeIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(BrassIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(NIckelIngotItem.block, (int) (1))
						.getItem()) && ((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								...
								.getItem() == new ItemStack(CobaltIngotItem.block, (int) (1)).getItem())))
				|| (((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(NIckelIngotItem.block, (int) (1))
						.getItem()) && (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(CobaltIngotItem.block, (int) (1))
						.getItem()) && (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								...
								.getItem() == new ItemStack(NIckelIngotItem.block, (int) (1)).getItem()) && ((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
										if (_ent != null) {
						...
						|| ((((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								...
								.getItem() == new ItemStack(CobaltIngotItem.block, (int) (1)).getItem()) && (((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
										if (_ent != null) {
										...
										.getItem() == new ItemStack(Items.IRON_INGOT, (int) (1)).getItem()) && ((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(NIckelIngotItem.block, (int) (1)).getItem())))
								|| ((((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(DarkIronIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
							...
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								...
								.getItem()) && ((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem() == new ItemStack(Items.CHARCOAL, (int) (1)).getItem()))))
				|| ((((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(Items.CHARCOAL, (int) (1)).getItem())
						&& (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
									...
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem() == new ItemStack(SteelIngotItem.block, (int) (1)).getItem()) && (((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(Items.CHARCOAL, (int) (1)).getItem()) && ((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
														TileEntity _ent = world.getTileEntity(pos);
														if (_ent != null) {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(FlowingWaterSteelIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(RoseGoldIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		if ((((((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _sltid = (int) (3);
					final ItemStack _setstack = new ItemStack(RedBrassIngotItem.block, (int) (1));
					_setstack.setCount((int) ((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(BronzeIngotItem.block, (int) (1)).getItem())
				&& (((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getItem()) && (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								...
								.getItem() == new ItemStack(BronzeIngotItem.block, (int) (1)).getItem()) && ((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
										if (_ent != null) {
							...
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								...
								.getItem() == new ItemStack(SilverIngotItem.block, (int) (1)).getItem()) && ((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem() == new ItemStack(BronzeIngotItem.block, (int) (1)).getItem())))
						|| ((((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
