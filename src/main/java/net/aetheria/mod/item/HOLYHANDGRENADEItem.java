...
import net.aetheria.mod.procedures.HOLYHANDGRENADERangedItemUsedProcedure;
import net.aetheria.mod.procedures.HOLYHANDGRENADEBulletHitsBlockProcedure;
...
public class HOLYHANDGRENADEItem extends AetheriaModElements.ModElement {
