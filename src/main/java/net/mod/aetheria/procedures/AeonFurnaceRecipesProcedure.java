...
import net.mod.aetheria.item.ZincIngotItem;
import net.mod.aetheria.item.TinIngotItem;
import net.mod.aetheria.item.SterlingSilverIngotItem;
import net.mod.aetheria.item.SteelIngotItem;
import net.mod.aetheria.item.SilverIngotItem;
import net.mod.aetheria.item.RoseGoldIngotItem;
import net.mod.aetheria.item.RedBrassIngotItem;
import net.mod.aetheria.item.PewterIngotItem;
import net.mod.aetheria.item.NIckelIngotItem;
import net.mod.aetheria.item.MagnegoldIngotItem;
import net.mod.aetheria.item.LeadIngotItem;
import net.mod.aetheria.item.FlowingWaterSteelIngotItem;
import net.mod.aetheria.item.ElectrumIngotItem;
import net.mod.aetheria.item.DarkIronIngotItem;
import net.mod.aetheria.item.CopperIngotItem;
import net.mod.aetheria.item.CobaltIngotItem;
import net.mod.aetheria.item.BronzeIngotItem;
import net.mod.aetheria.item.BrassIngotItem;
import net.mod.aetheria.item.BlacksteelIngotItem;
import net.mod.aetheria.item.BlackBronzeIngotItem;
import net.mod.aetheria.item.BismuthIngotItem;
import net.mod.aetheria.item.BismuthBronzeIngotItem;
