...
public class CherryWoodBlock extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:cherry_wood")
	public static final Block block = null;
	public CherryWoodBlock(AetheriaModElements instance) {
		super(instance, 607);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 2f).lightValue(0).harvestLevel(2)
