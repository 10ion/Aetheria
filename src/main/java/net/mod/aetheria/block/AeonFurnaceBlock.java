...
import net.mod.aetheria.gui.AeonFurnaceGUIGui;
...
public class AeonFurnaceBlock extends AetheriaModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).lightValue(8).harvestLevel(3)
