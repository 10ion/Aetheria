...
import net.mod.aetheria.procedures.MossyOakNaturalGrowthProcedure;
import net.mod.aetheria.procedures.MossyOakBonemealGrowthProcedure;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				MossyOakNaturalGrowthProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MossyOakBonemealGrowthProcedure.executeProcedure($_dependencies);
			}
