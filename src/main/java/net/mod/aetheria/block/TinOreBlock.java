...
public class TinOreBlock extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:tinore")
	public static final Block block = null;
	public TinOreBlock(AetheriaModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.1f, 12f).lightValue(0));
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 10)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(24, 0, 0, 58))));
		}
	}
}
