...
public class SilverwoodPlanksBlock extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:silverwood_planks")
	public static final Block block = null;
	public SilverwoodPlanksBlock(AetheriaModElements instance) {
		super(instance, 753);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("silverwood_planks");
		}
