...
public class SilverwoodStairsBlock extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:silverwood_stairs")
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.WOOD).sound(SoundType.WOOD)
					.hardnessAndResistance(3f, 3f).lightValue(0).harvestLevel(1).harvestTool(ToolType.AXE));
			setRegistryName("silverwood_stairs");
		}
