...
import net.mod.aetheria.procedures.AeonguicodeProcedure;
import net.mod.aetheria.itemgroup.AetheriaCraftingItemGroup;
import net.mod.aetheria.gui.AeonForgeguiGui;
...
public class AeonForgeBlock extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:aeonforge")
	public static final Block block = null;
	@ObjectHolder("aetheria:aeonforge")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AeonForgeBlock(AetheriaModElements instance) {
		super(instance, 230);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				AeonguicodeProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Aeon Forge");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("aeonforge");
		}
