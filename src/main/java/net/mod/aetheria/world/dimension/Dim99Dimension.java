...
import net.mod.aetheria.item.Dim99Item;
import net.mod.aetheria.block.StyxWaterBlock;
...
public class Dim99Dimension extends AetheriaModElements.ModElement {
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = Dim99Dimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dim_9_9_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
