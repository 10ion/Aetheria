...
import net.mod.aetheria.block.VoidStoneBlock;
...
public class CrocoiteLargeStructure extends AetheriaModElements.ModElement {
	public CrocoiteLargeStructure(AetheriaModElements instance) {
		super(instance, 306);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aetheria", "crocoitelarge"));
						if (template == null)
							return false;
