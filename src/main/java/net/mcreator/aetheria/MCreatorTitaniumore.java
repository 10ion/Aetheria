...
public class MCreatorTitaniumore extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:titaniumore")
	public static final Block block = null;

	public MCreatorTitaniumore(Elementsaetheria instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(10f, 25f).lightValue(0).harvestLevel(3)
