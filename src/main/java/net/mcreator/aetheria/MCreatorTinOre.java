...
public class MCreatorTinOre extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:tinore")
	public static final Block block = null;

	public MCreatorTinOre(Elementsaetheria instance) {
		super(instance, 190);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 9), Placement.COUNT_RANGE, new CountRangeConfig(6, 0, 0, 60)));
		}
	}
}
