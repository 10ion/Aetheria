...
public class MCreatorVoidCrystle extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:voidcrystle")
	public static final Block block = null;

	public MCreatorVoidCrystle(Elementsaetheria instance) {
		super(instance, 319);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("voidcrystle", "voidcrystle", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == MCreatorVoidStone.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 1), Placement.COUNT_RANGE, new CountRangeConfig(8, 0, 0, 256)));
		}
	}
}
