...
public class MCreatorOmnessence1 extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:omnessence1")
	public static final Effect potion = null;

	public MCreatorOmnessence1(Elementsaetheria instance) {
		super(instance, 140);
	...
	public static class EffectCustom extends Effect {
		...
		public void performEffect(LivingEntity entity, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorOmnessence1OnPotionActiveTick.executeProcedure($_dependencies);
			}
		}
