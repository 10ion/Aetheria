...
public class MCreatorVoidshromblock extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:voidshromblock")
	public static final Block block = null;

	public MCreatorVoidshromblock(Elementsaetheria instance) {
		super(instance, 305);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorVoidshroom.block, (int) (0)));
		}
	}
}
