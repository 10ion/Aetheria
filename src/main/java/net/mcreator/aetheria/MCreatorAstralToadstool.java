...
public class MCreatorAstralToadstool extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:astraltoadstool")
	public static final Block block = null;

	public MCreatorAstralToadstool(Elementsaetheria instance) {
		super(instance, 294);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).lightValue(1));
			setRegistryName("astraltoadstool");
		}
