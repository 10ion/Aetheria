...
public class BismuthArmorItem extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:bismuth_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("aetheria:bismuth_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("aetheria:bismuth_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("aetheria:bismuth_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AetheriaArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "aetheria:textures/models/armor/bismutharmor__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
