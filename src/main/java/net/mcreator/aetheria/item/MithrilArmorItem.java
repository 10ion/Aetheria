...
public class MithrilArmorItem extends AetheriaElements.ModElement {
	...
	public MithrilArmorItem(AetheriaElements instance) {
		super(instance, 369);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "aetheria:textures/models/armor/mithril_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
