...
public class MCreatorBlueCrocoite extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:bluecrocoite")
	public static final Block block = null;

	public MCreatorBlueCrocoite(Elementsaetheria instance) {
		super(instance, 320);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorCrocoiteShard.block, (int) (1)));
		}
