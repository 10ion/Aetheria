...
public class MCreatorCopperOre extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:copperore")
	public static final Block block = null;

	public MCreatorCopperOre(Elementsaetheria instance) {
		super(instance, 196);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 18), Placement.COUNT_RANGE, new CountRangeConfig(12, 0, 0, 68)));
		}
	}
}
