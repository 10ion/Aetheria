...
public class MCreatorSilverwoodforest extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:silverwoodforest")
	public static final CustomBiome biome = null;

	public MCreatorSilverwoodforest(Elementsaetheria instance) {
		super(instance, 204);
	}
		...
		public CustomBiome() {
			super(new Biome.Builder()
					...
					.surfaceBuilder(
							...
							new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.DIRT
									.getDefaultState())));
