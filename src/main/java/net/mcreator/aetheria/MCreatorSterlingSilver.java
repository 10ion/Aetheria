...
public class MCreatorSterlingSilver extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:sterlingsilver")
	public static final Item block = null;

	public MCreatorSterlingSilver(Elementsaetheria instance) {
		super(instance, 38);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sterlingsilver");
		}
