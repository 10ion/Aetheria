...
public class MCreatorRedsteelarmor extends Elementsaetheria.ModElement {
	...
	public MCreatorRedsteelarmor(Elementsaetheria instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(MCreatorRedsteelingot.block, (int) (1)));
			}
