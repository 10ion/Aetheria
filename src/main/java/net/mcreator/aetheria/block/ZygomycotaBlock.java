...
public class ZygomycotaBlock extends AetheriaModElements.ModElement {
	@ObjectHolder("aetheria:zygomycota")
	public static final Block block = null;
	public ZygomycotaBlock(AetheriaModElements instance) {
		super(instance, 134);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
					Biome.createDecoratedFeature(feature, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_HEIGHTMAP_32, new FrequencyConfig(40)));
		}
	}
