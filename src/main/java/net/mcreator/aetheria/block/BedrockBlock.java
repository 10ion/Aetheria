	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(100f, 18000f).lightValue(0).harvestLevel(7)
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Tough Miner"));
		}
