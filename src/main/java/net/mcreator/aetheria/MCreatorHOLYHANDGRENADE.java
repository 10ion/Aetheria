...
public class MCreatorHOLYHANDGRENADE extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:holyhandgrenade")
	public static final Item block = null;
	@ObjectHolder("aetheria:entitybulletholyhandgrenade")
	public static final EntityType arrow = null;

	public MCreatorHOLYHANDGRENADE(Elementsaetheria instance) {
		super(instance, 198);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity> create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				0.5f, 0.5f)).build("entitybulletholyhandgrenade").setRegistryName("entitybulletholyhandgrenade"));
	}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "ranged_item_damage",
						(double) -1.9, AttributeModifier.Operation.ADDITION));
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				world.addEntity(entityarrow);
				{
					...
					MCreatorHOLYHANDGRENADERangedItemUsed.executeProcedure($_dependencies);
				}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MCreatorHOLYHANDGRENADE.block, (int) (1));
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				MCreatorHOLYHANDGRENADEBulletHitsBlock.executeProcedure($_dependencies);
			}
		}
