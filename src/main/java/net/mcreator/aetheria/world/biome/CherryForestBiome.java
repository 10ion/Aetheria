...
public class CherryForestBiome extends AetheriaModElements.ModElement {

	@ObjectHolder("aetheria:cherry_forest")
	public static final CustomBiome biome = null;

	public CherryForestBiome(AetheriaModElements instance) {
		super(instance, 610);
	}
