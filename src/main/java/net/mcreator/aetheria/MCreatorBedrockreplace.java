...
public class MCreatorBedrockreplace extends Elementsaetheria.ModElement {
	public MCreatorBedrockreplace(Elementsaetheria instance) {
		super(instance, 145);
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MCreatorBedrockreplace!");
			return;
		}
