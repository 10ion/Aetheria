...
public class MCreatorAstraltoodstool extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:astraltoodstool")
	public static final Block block = null;

	public MCreatorAstraltoodstool(Elementsaetheria instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorAstralToadstool.block, (int) (0)));
		}
	}
}
