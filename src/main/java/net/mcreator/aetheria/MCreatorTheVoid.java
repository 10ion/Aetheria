...
public class MCreatorTheVoid extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:thevoid")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;

	public MCreatorTheVoid(Elementsaetheria instance) {
		super(instance, 142);
		...
		if (event.getTo() == type) {
			{
				...
				MCreatorTheVoidPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}
