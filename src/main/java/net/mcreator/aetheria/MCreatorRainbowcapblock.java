...
public class MCreatorRainbowcapblock extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:rainbowcapblock")
	public static final Block block = null;

	public MCreatorRainbowcapblock(Elementsaetheria instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorRainbowCap.block, (int) (0)));
		}
	}
}
