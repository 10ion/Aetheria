...
public class Elementsaetheria {
	...
	public Elementsaetheria() {
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == Elementsaetheria.ModElement.class)
						elements.add((Elementsaetheria.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(Elementsaetheria.ModElement::initElements);
	...
	public void registerSounds(RegistryEvent.Register<net.minecraft.util.SoundEvent> event) {
		ResourceLocation sound0 = new ResourceLocation("aetheria", "keekuu");
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final Elementsaetheria elements;
		protected final int sortid;

		public ModElement(Elementsaetheria elements, int sortid) {
