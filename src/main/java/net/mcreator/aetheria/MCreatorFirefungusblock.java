...
public class MCreatorFirefungusblock extends Elementsaetheria.ModElement {
	@ObjectHolder("aetheria:firefungusblock")
	public static final Block block = null;

	public MCreatorFirefungusblock(Elementsaetheria instance) {
		super(instance, 308);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("firefungusblock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorFireshroom.block, (int) (0)));
		}
	}
}
